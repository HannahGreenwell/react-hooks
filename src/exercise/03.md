...
- place code (state, context providers, tests, docs etc) as close where it's
  relevant as possible (maintainence and performance)
- how to decide where to put state (diagram)
